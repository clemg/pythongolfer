...
---
### How does it work ?
It simply takes your input and uses a single line of Python code to convert it, and then display the result to the screen with the code needed to execute it.
