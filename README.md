...
Where the ungolfed code contains the precise string `. `, for some reasons, the coated string after the returned code is reversed. It turns into `','u16')[2:])`. Also, this string appears in the middle. (See [#2](https://github.com/clemg/pythongolfer/issues/2))
